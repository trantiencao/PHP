    ...
    <form id="form1" name="form1" method="post" action="">
        ...
        <fieldset>
            ...
            <p>
                ...
                <label>
                    <input type="radio" name="pheptinh" value="tích" <?php if (isset($_POST['pheptinh']) && ($_POST['pheptinh']) == "tích") echo 'checked' ?> />
                    Nhân
                </label>
                <label>
                    <input type="radio" name="pheptinh" value="thương" <?php if (isset($_POST['pheptinh']) && ($_POST['pheptinh']) == "thương") echo 'checked' ?> />
                    Chia
                </label>
            </p>
        </fieldset>
